...
# The progressions are based on I - V - vi - IV for major, and i - V - i - III for minor

# Chord intervals for major and minor chords in a scale
chord_intervals_major = [0, 4, 7]  # (Root, Major 3rd, Perfect 5th)
chord_intervals_minor = [0, 3, 7]  # (Root, Minor 3rd, Perfect 5th)


# Root MIDI note numbers for C major (60), C minor (57)
# Generate progressions for all 12 keys by shifting root notes
def generate_progressions(root_note):
    """Generate major and minor progressions for a given root note."""
    # Major scale (I - V - vi - IV)
    major_progression = [
    ...
    # Bassline root notes (corresponding to root notes of each chord)
...
def create_midi(melody, bassline, filename="generated/randomized_trance_melody.mid"):
